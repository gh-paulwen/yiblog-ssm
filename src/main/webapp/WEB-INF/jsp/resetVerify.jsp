	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
			   ...
			   <form id="form_verify" action="${pageContext.request.contextPath }/resetVerify" method="POST" style="width:50%">
			       <input name="email" type="hidden" value="${email }">
			       <h5></h5>
                   <input name="code" type="text" class="form-control">
                   <h5></h5>
                   <button id="btn_verify" type="button" class="btn btn-default">提交</button>
			   </form>
			</div>
			<div class="col-md-4">
			    <div class="well">
