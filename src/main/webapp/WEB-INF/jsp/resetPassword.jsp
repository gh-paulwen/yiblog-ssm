...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
			   <h4>请输入邮箱${email }收到的验证码</h4>
			   <form id="form_reset" action="${pageContext.request.contextPath }/resetPassword" method="POST" style="width:50%">
                   ...
                   <h5></h5>
                   <button id="btn_reset" type="button" class="btn btn-default">提交</button>
			   </form>
			</div>
			<div class="col-md-4">
			    <div class="well">
