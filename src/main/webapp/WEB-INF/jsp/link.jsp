        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="well">
                    ...
                    <form:form action="${pageContext.request.contextPath }/link/submitSave" method="POST" modelAttribute="link">
                        <div class="form-group">
                            <h4>申请友链 （以下均为必填字段）:</h4>
                            <form:input path="name" class="form-control" placeholder="网站名字"/>
                            <h4></h4>
                            <form:input path="url" class="form-control" placeholder="网站链接" value="http://"/>
                            <h4></h4>
                            <form:input path="email" class="form-control" placeholder="您的邮箱"/>
                            <h4></h4>
                            <form:textarea path="introduction" class="form-control" rows="3" placeholder="网站简介"></form:textarea>
                        </div>
